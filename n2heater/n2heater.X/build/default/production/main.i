...
# 1 "/opt/microchip/mplabx/v5.40/packs/Microchip/PIC18F-K_DFP/1.4.87/xc8/pic/include/__null.h" 1 3
...
const char *build_date = "Aug 17 2020", *build_time = "11:00:54", build_version[5] = "1.0";
...
uint16_t controller_work(void)
{
 static uint16_t pwm_val = 430;

 ADCC_StartConversion(AIR_TEMP);
 while (!ADCC_IsConversionDone());

 if ((temp = ADCC_GetConversionResult()) > 1250) {
  pwm_val = 300;
 }
 ...
 if ((flow = ADCC_GetConversionResult()) > 4000) {
  if (max_heat_time >= 30000) {
   do { LATDbits.LATD1 = 0; } while(0);
   do { LATAbits.LATA5 = 0; } while(0);
   max_heat_time = 30000 + 1;
   return 1;
  } else {
   do { LATDbits.LATD1 = 1; } while(0);
   do { LATAbits.LATA5 = 1; } while(0);
